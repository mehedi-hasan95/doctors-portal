    ...
    return (
        <div className="grid max-w-screen-xl grid-cols-1 gap-8 px-8 py-16 mx-auto rounded-lg md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 bg-gray-800 text-gray-100">
            <div className="flex flex-col justify-between">
                ...
                <img src="https://img.freepik.com/free-vector/contact-us-concept-landing-page_52683-12860.jpg?t=st=1669133875~exp=1669134475~hmac=b04baabe566eb1339fd77fa816b3be4eda004bf937e13bbb530d888b3c77813e" alt="" className="p-6 h-52 md:h-64" />
            </div>
